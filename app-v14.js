...
exports.router = exports.navigation = undefined;
...
var _navigation = require('models/navigation');

var _navigation2 = _interopRequireDefault(_navigation);

var _menuHamburger = require('blocks/menu-hamburger');

var _menuHamburger2 = _interopRequireDefault(_menuHamburger);

var _menu3 = require('blocks/menu');
...
var _viewport = require('blocks/viewport');

var _viewport2 = _interopRequireDefault(_viewport);

var _points = require('blocks/points');

var _points2 = _interopRequireDefault(_points);

var _footer = require('blocks/footer');
...
var navigation = exports.navigation = new _navigation2.default({
  sections: ["", "works/1", "works/2", "works/3", "works/4", "works/5", "works/6", "works/7", "works/8", "contact"],
  section: ""
});
...
var hamburger = new _menuHamburger2.default({ model: menu });
var menuView = new _menu4.default({ model: menu });
var header = new _header2.default({ model: menu });
var viewport = new _viewport2.default({ model: navigation });
var points = new _points2.default({ model: navigation, menu: menu }).render().setPoint(0);
var footer = new _footer2.default({ model: navigation });

_backbone.history.start({ pushState: false });

setTimeout(function () {
  (0, _jquery2.default)(".app").addClass("app_loaded");
}, 720);

},{"./router":2,"backbone":3,"blocks/footer":26,"blocks/header":27,"blocks/menu":29,"blocks/menu-hamburger":28,"blocks/points":30,"blocks/viewport":31,"jquery":23,"models/menu":32,"models/navigation":33}],2:[function(require,module,exports){
"use strict";
...
module.exports = exports['default'];
},{"./private/utils":18}],6:[function(require,module,exports){
/**
 * core-decorators.js
...
},{"./applyDecorators":4,"./autobind":5,"./debounce":7,"./decorate":8,"./deprecate":9,"./enumerable":10,"./extendDescriptor":11,"./lazy-initialize":12,"./memoize":13,"./mixin":14,"./nonconfigurable":15,"./nonenumerable":16,"./override":17,"./readonly":19,"./suppress-warnings":20,"./throttle":21,"./time":22}],7:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],8:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],9:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],10:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],11:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],12:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],13:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],14:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],15:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],16:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],17:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],18:[function(require,module,exports){
'use strict';
...
},{"../lazy-initialize":12}],19:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],20:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],21:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./private/utils":18}],22:[function(require,module,exports){
'use strict';
...
},{"./private/utils":18}],23:[function(require,module,exports){
/*!
...
},{"./router":2,"backbone":3,"blocks/footer":26,"blocks/header":27,"blocks/menu":29,"blocks/menu-hamburger":28,"blocks/points":30,"blocks/viewport":31,"jquery":23,"models/menu":32,"models/navigation":33}],26:[function(require,module,exports){
"use strict";
...
var Header = function (_View) {
  ...
  _createClass(Header, [{
    ...
    value: function initialize() {
      ...
      this.$el.find(".js-footer__back-to-top").on("click", function () {
        _this2.model.to(0);
      });

      this.listenTo(this.model, "change:sectionIdx", function () {
        var $btt = _this2.$el.find(".js-footer__back-to-top");

        $btt.toggleClass("footer__back-to-top_hidden", _this2.model.get("sectionIdx") != 0);
      });
    }
  }, {
    key: "el",
...
},{"backbone":3}],27:[function(require,module,exports){
"use strict";
...
var Header = function (_View) {
  ...
  _createClass(Header, [{
    ...
    value: function initialize() {
      ...
      this.listenTo(this.model, "change:open", function () {
        _this2.$(".js-header__title").toggleClass("header__title_hidden", _this2.model.get("open"));
      });
    }
  }, {
    key: "el",
...
},{"backbone":3}],28:[function(require,module,exports){
"use strict";
...
var MenuHamburger = function (_View) {
  _inherits(MenuHamburger, _View);

  function MenuHamburger() {
    _classCallCheck(this, MenuHamburger);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MenuHamburger).apply(this, arguments));
  }
  ...
  _createClass(MenuHamburger, [{
    ...
    value: function initialize() {
      ...
      this.$el.on("click", function () {
        _this2.model.set("open", !_this2.model.get("open"));
      });

      this.listenTo(this.model, "change:open", function () {
        _this2.$el.toggleClass("hamburger_open", _this2.model.get("open"));
      });
    }
  }, {
    key: "el",
    get: function get() {
      return ".js-hamburger-menu";
    }
  }]);
...
},{"backbone":3}],29:[function(require,module,exports){
'use strict';
...
var Menu = function (_View) {
  ...
  _createClass(Menu, [{
    ...
    value: function initialize() {
      ...
      this.listenTo(this.model, "change:open", function () {
        _this2.$el.toggleClass("menu_open", _this2.model.get("open"));
      });

      this.$el.on("click", ".js-menu__link", function (e) {
        var to = _app.navigation.get("sections").indexOf(e.target.hash.replace("#", ""));

        _app.navigation.to(to);
        _this2.model.set("open", false);
      });
    }
  }, {
    key: 'el',
...
},{"app":25,"backbone":3}],30:[function(require,module,exports){
'use strict';
...
var Viewport = function (_View) {
  ...
  _createClass(Viewport, [{
    ...
    value: function initialize(options) {
      ...
      this.listenTo(this.model, "change:sectionIdx", this.setPoint);

      this.$el.on("click", ".js-point", function (e) {
        _this2.model.to(parseInt((0, _jquery2.default)(e.target).data("idx")));
      });

      this.listenTo(options.menu, "change:open", function () {
        _this2.$el.toggleClass("points_menu-open", options.menu.get("open"));
      });
    }
  }, {
    key: 'render',
    value: function render() {
      this.$el.find(".js-points__list").html(this.model.get("sections").map(function (s, i) {
        return '<li class="points__item"><a href="javascript:void(0)" class="points__link js-point" data-idx="' + i + '"></a></li>';
      }).join(""));
    ...
    value: function setPoint() {
      this.$el.find(".js-point").removeClass("points__link_active").eq(this.model.get("sectionIdx")).addClass("points__link_active");
    }
  }, {
    key: 'el',
    get: function get() {
...
},{"backbone":3,"jquery":23,"router":34}],31:[function(require,module,exports){
'use strict';
...
var Viewport = (_dec = (0, _coreDecorators.debounce)(50), (_class = function (_View) {
  _inherits(Viewport, _View);
  ...
  _createClass(Viewport, [{
    ...
    value: function initialize() {
      ...
      this.listenTo(this.model, "change:sectionIdx", this.setScroll);
      (0, _jquery2.default)(window).on("resize", this.setScroll.bind(this));
      ...
      if ('ontouchstart' in document.documentElement) {
        (function () {
          ...
          (0, _jquery2.default)(document.body).on("touchmove", function (e) {
            e.preventDefault();

            var newTouch = e.originalEvent.touches[0].clientY;
            var delta = newTouch - lastTouch;

            if (!touchUsed && lastTouch && Math.abs(delta) > 30) {
              if (delta < 0) {
                _this2.model.next();
              } else {
                _this2.model.prev();
              ...
              return touchUsed = true;
            }

            lastTouch = newTouch;
          });

          (0, _jquery2.default)(document.body).on("touchend", function (e) {
            lastTouch = 0;
            touchUsed = false;
          });
        })();
        ...
        (0, _jquery2.default)(window).on("mousewheel DOMMouseScroll", function (e) {
          e.preventDefault();
          _this2.model.handleScroll(e.originalEvent.deltaY);
        });
      }
    }
  }, {
    ...
    value: function setScroll() {
      var idx = this.model.get("sectionIdx");
      var pos = scroll(-(idx * this.$el.height()));

      this.$el.children().first().css(pos);

      this.$el.children().removeClass("screen_active").filter(':lt(' + (idx + 1) + ')').addClass("screen_active");
    }
  }, {
    key: 'el',
    get: function get() {
  ...
  return Viewport;
}(_backbone.View), (_applyDecoratedDescriptor(_class.prototype, 'setScroll', [_dec], Object.getOwnPropertyDescriptor(_class.prototype, 'setScroll'), _class.prototype)), _class));
exports.default = Viewport;

},{"backbone":3,"core-decorators":6,"jquery":23}],32:[function(require,module,exports){
'use strict';
...
},{"backbone":3}],33:[function(require,module,exports){
'use strict';
...
var deltas = 0;
var beingScrolled = false;
var THROTTLE_THRESHOLD = 20;
var _scrollTimeout;
...
var Navigation = function (_Model) {
  ...
  _createClass(Navigation, [{
    ...
    value: function initialize() {
      this._lastDelta = 0;
      this.set("sectionIdx", this.get("sections").indexOf(this.get("section")));
    }
  }, {
    key: 'next',
    value: function next() {
      var sections = this.get("sections");
      var next = sections.indexOf(this.get("section")) + 1;
    ...
    value: function prev() {
      var sections = this.get("sections");
      var prev = sections.indexOf(this.get("section")) - 1;

      if (prev >= 0 && prev < sections.length) {
        this.set({
          "sectionIdx": prev,
          "section": sections[prev]
        });
      }
    }
  }, {
    ...
    value: function to(idx) {
      var section = this.get("sections")[idx];
    ...
    key: 'updateSection',
    value: function updateSection(d) {
      if (d) {
        var sections = this.get("sections");
        var idx = sections.indexOf(this.get("section"));
        var next = idx + (d > 0 ? 1 : -1);
    ...
    value: function handleScroll(d) {
      ...
      setTimeout(function () {
        var wasBeingScrolled = beingScrolled;

        beingScrolled = --deltas > 0;

        if (!wasBeingScrolled && beingScrolled) {
          _this2.updateSection(d);
        }
      }, isSafari ? 100 : 50);
    }
  }]);
...
},{"backbone":3,"core-decorators":6,"jquery":23}],34:[function(require,module,exports){
